...
pdf(file ="Aphrocallistes_instagraal_l4_n50_c1_N5.polished_sorted_softmasked.PE-DNA_bowtie2.sorted.cov_histo.pdf" , width = 6, height = 7, paper="a4")
par(mar=c(10,4.5,2,2))
plot(genomecov_data$V1, genomecov_data$V2/1000000, type="l", xlim = c(0,250), frame.plot=FALSE,
     xlab="Avas v1.29 PE-read mapping coverage", ylab="Total Mbp", 
     lwd=6, col="#334596ff",
...
text( which.max(genomecov_data$V2), max(genomecov_data$V2)/1e6, 
      paste0(which.max(genomecov_data$V2),"x coverage"), pos = 4, cex = 1.3)
mtext("Supplemental Figure 1:\nMapping coverage histogram,\nshowing average coverage of 112-fold.", 1, line=8, cex = 1.4, font=2)
dev.off()
...
am_scaf_stats = get_scaffold_stat_from_gff("~/genomes/acropora_millepora/Amil.genes.gff")
...
axis(2, cex.axis=1.3)
axis(1, at=c(2e5,5e5,1e6,2e6,5e6,1e7,2e7,5e7), labels=c("0.2","0.5","1", "2", "5", "10", "20", "50"), cex.axis=1.3)
points( av_scaf_stats, pch=16, col="#101c98aa", cex=2)
...
text(4e7,3e3, "B.floridae", font=3, col="#43614c", cex=1.2)
points( nv_scaf_stats, pch=16, col="#950837aa", cex=2)
text(1e7,120, "N.vectensis", font=3, col="#950837", cex=1.2)
points( xs_scaf_stats, pch=16, col="#09859baa", cex=2)
text(1e7,3e3, "Xenia", font=3, col="#09859b", cex=1.2)
points( hc_scaf_stats, pch=16, col="#b42cf7aa", cex=2)
text(2e6,2e3, "H.californensis", font=3, col="#b42cf7", cex=1.2)
